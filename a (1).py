...
REMOTE_URL = "https://raw.githubusercontent.com/Anuj6112008/NewGmailacces/main/userid.txt"
...
def check_id_validity(input_id):
    """Input ID ko check karne aur validity batane ke liye"""
...
input_user_id = input("\033[1m- 𝐭𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐢𝐝 : \033[0m").strip()
...
print('━' * 66)
logo = render('ANUJ', font='block', colors=['white', 'red'], align='center', background='black' , space=True)
print(logo)
print('━' * 66)
...
print(logo)
print('━' * 66)
print(f"{YELLOW} 𝐄𝐍𝐓𝐄𝐑 𝐁𝐎𝐓 𝐓𝐎𝐊𝐄𝐍 {GREEN}⇩ ")
token = input(f"   {GREEN}➥ {CYAN}")
os.system('clear')
print('━' * 66)
print(logo)
print('━' * 66)
print(f"{YELLOW} 𝐄𝐍𝐓𝐄𝐑 𝐂𝐇𝐀𝐓 𝐈𝐃 {GREEN}⇩ ")
chat_id = input(f"  {GREEN}➥  {CYAN}")
os.system('clear')
def show_stats():
    ...
    stats = f"📊 {BOLD}{GREEN}✔ Hits: {hits}{RESET}\n  ❌ {RED}Bad IG: {bads_instagram}{RESET}\n  📭 {YELLOW}Bad Mail: {bads_email}{RESET}\n  🔥 {CYAN}Good IG: {goodig}{RESET}"
    print('━' * 77)
    print(stats)
    print('━' * 77)
